...
var PrismaUniversal = /** @class */ (function (_super) {
    __extends(PrismaUniversal, _super);
    function PrismaUniversal() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    PrismaUniversal.prototype.onModuleInit = function () {
    ...
    PrismaUniversal.prototype.convertDecimal = function (params, next) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        try {
                            ...
                            console.error("PrismaNext converting error => ".concat(e));
                        }
